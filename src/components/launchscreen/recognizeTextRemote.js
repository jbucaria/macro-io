...
import useRecognizeTextRemote from '@/src/components/launchscreen/useRecognizeTextRemote'

// RecognizeTextRemote component
const RecognizeTextRemote = ({ onClose, onFoodDetail }) => {
...
export default RecognizeTextRemote

...
import { useQuickNutritionScan } from '@/src/components/launchscreen/useQuickNutritionScan'
import { NutritionFactView } from '@/src/components/launchscreen/nutritionFactView'

export const NutritionFactScreen = ({ onClose }) => {

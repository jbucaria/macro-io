...
export const useQuickScan = () => {
  ...
  const [alternative, setAlternativePassioIDAttributes] = useState(null)
  const [loading, setLoading] = useState(true)
  const passioFoodItemRef = useRef(null)
  ...
  const onAlternativeFoodItemChange = useCallback(async attribute => {
